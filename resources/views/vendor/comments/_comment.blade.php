...
@endif
    ...
    <img class="mr-3 img-thumbnail" src="/images/user/{{ $comment->commenter->profile_image }}" width="50" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
    @else
    <img class="mr-3 img-thumbnail" src="/images/user/guest.jpg" width="50" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
    @endif
    <div class="media-body">
        <h6 class="mt-0 mb-1" style="color: #3490dc;"><b>{{ $comment->commenter->name ?? $comment->guest_name }}</b> <small class="text-muted">- {{ $comment->created_at->diffForHumans() }}</small></h6>
