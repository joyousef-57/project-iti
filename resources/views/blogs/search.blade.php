...
@section('content') 
    <div class="container-fluid" style="width: 85%;  padding: 25px 20px 20px 20px;">
        @if($blogs->count() >= 1)    
            <div style="background-color:#fff; padding: 20px 0px 10px 0px; box-shadow: 0px 5px 15px 3px rgba(177, 174, 174, 0.3); border-left: 3px solid rgba(52, 144, 220, 0.7);">
                <h4 class="text-center">Search Results for <span style="color: #3490dc;"><strong>"{{ $search_query }}"</strong></span></h4>
            </div>
            <div class="row justify-content-center" style="margin-top: 10px; margin-bottom: -20px;">
                <span style="background-color: #3490dc; color: #fff; padding: 3px 10px; margin-bottom: 15px;">Results Found : {{ $blogs->count() }} </span>
            </div>
        ...
        @else
            <div class="row" style="padding-top: 17%;">
                <div class="col-md-5" style=" padding-right: 30px;">
                    <i class="fa fa-exclamation-triangle" aria-hidden="true" style="font-size: 180px; color: rgba(52, 144, 220, 0.9); float: right;"></i>
                </div>
                <div class="col-md-7" style="padding-top: 2%;">
                    <h1 style="opacity: 0.8;">Sorry!!!</h1>
                    <h1 style="opacity: 0.8;">Result Not Found for <span style="color: #3490dc;"><strong>"{{ $search_query }}"</strong></span></h1>
                </div>
            </div>
        @endif
    </div>
